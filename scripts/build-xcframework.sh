...
# source with -Z build-std on nightly. CI builds that only archive the iPhone
# app can set SKIP_WATCHOS=1 and avoid this unrelated tier-3 slice entirely.
NIGHTLY="${NIGHTLY_TOOLCHAIN:-nightly}"
SKIP_WATCHOS="${SKIP_WATCHOS:-0}"
